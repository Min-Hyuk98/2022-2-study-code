...
Original file is located at
    https://colab.research.google.com/github/PyTorchKorea/tutorials-kr/blob/master/docs/_downloads/4e865243430a47a00d551ca0579a6f6c/cifar10_tutorial.ipynb
"""
## 방법 1.

# alpha를 따로 정의하고 no_grad 안에서 직접 optimizer.step역할 해줌... 이후 grad =None으로 초기화해주기
...
# 를 모델 (nn.module 을 상속한 클래스)에 등록한다
